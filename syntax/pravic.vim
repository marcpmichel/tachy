...
syn match pravicKeyword /\v<(vars|var|files|file|directories|directory|packages|package|groups|group|users|user|services|service|repos|repo|hosts|host|imports|import|webui|identity|output|apply|asserts|assert|ensure|choose|compose|http)\ze%([ \t\r\n"'{}\[\]=#,\\]|$)/ display
