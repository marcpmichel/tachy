...
syn match pravicKeyword /\v<(vars|var|files|file|directories|directory|packages|package|groups|group|users|user|services|service|hosts|host|imports|import|webui|include|check|compose)\ze%([ \t\r\n"'{}\[\]=#,\\]|$)/ display
