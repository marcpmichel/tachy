...
private immutable string[] allModules = [
    "file", "service", "ensure", "assert", "group", "user", "package", "compose", "probe", "repo", "debug"
];
...
void validateModuleParams(string moduleName, in Val[string] params, string context)
{
    switch(moduleName) {
        case "file":
            checkKeys(params, [
                "path", "state", "src", "content", "line", "block",
        ...
        case "user":
            checkKeys(params, [
                "name", "group", "groups", "shell", "comment",
                "create_home", "home", "state", "remove_home"
            ], context ~ " (user)");
            if("name" !in params)
        ...
        case "compose": {
            checkKeys(params, [
                "dir", "file", "project", "services", "state", "pull",
...
TaskResult runModule(string moduleName, Val[string] params, TaskContext ctx)
{
    switch(moduleName) {
        case "file":
            return runFileModule(params, ctx);
        case "service":
            return runServiceModule(params, ctx);
        case "ensure":
            return runEnsureModule(params, ctx);
        case "assert":
            return runAssertModule(params, ctx);
        case "group":
            return runGroupModule(params, ctx);
        case "user":
            return runUserModule(params, ctx);
        case "package":
            return runPackageModule(params, ctx);
        case "repo":
            return runRepoModule(params, ctx);
        case "compose":
            return runComposeModule(params, ctx);
        case "probe":
            return runProbeModule(params, ctx);
        case "debug":
            return runDebugModule(params, ctx);
        default:
            throw new TachyError("unknown module '" ~ moduleName ~ "'");
    }
}
